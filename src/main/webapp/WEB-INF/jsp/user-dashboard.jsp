...
<div class="layout"><aside class="sidebar"><a class="side-link active" onclick="switchTab('orders')">我的预约</a><a class="side-link" onclick="switchTab('emr')">电子病历</a><a class="side-link" onclick="mockLogin()">模拟登录</a></aside>
