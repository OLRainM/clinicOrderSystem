...
<header class="app-header"><div class="brand">患者预约中心</div><nav class="nav"><a href="/">患者首页</a><a href="/#departments">继续预约</a></nav></header>
...
<script src="/role-nav.js"></script><script src="/dashboard.js"></script><script>renderRoleNav();</script>
</body></html>
