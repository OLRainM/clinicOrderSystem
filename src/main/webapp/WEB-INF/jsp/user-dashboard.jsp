...
<header class="app-header"><div class="brand">患者预约中心</div><nav class="nav"><a href="/">患者首页</a><a href="/department/1">继续预约</a><a href="/doctor">医生端</a><a href="/admin/login">管理端</a></nav></header>
<div class="layout"><aside class="sidebar"><a class="side-link active">预约记录</a><a class="side-link" href="/department/1">预约挂号</a></aside><main class="main"><div class="page-title"><h2>当前/过往预约</h2><button class="btn secondary" onclick="loadOrders()">刷新</button></div><table class="table"><thead><tr><th>订单号</th><th>科室/医生</th><th>预约时间</th><th>状态</th><th>操作</th></tr></thead><tbody id="orderRows"><tr><td colspan="5">加载中...</td></tr></tbody></table></main></div>
