...
<header class="app-header"><div class="brand">云诊所 Clinic</div><nav class="nav"><a href="/department/1">预约挂号</a><a href="/user/dashboard">个人中心</a><a href="/doctor/workspace">医生工作台</a><a href="/admin/dashboard">管理后台</a></nav></header>
