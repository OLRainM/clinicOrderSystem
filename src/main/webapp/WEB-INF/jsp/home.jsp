...
<header class="app-header"><div class="brand">云诊所患者端</div><nav class="nav"><a href="/#departments">预约挂号</a><a href="/user/dashboard">患者预约中心</a><a href="/login/doctor">医生端</a><a href="/admin/login">管理端</a></nav></header>
<section class="hero"><h1>在线预约、电子病历、处方下载一站完成</h1><p>请先选择科室，再选择医生和具体时间段。</p></section>
