...
<header class="app-header"><div class="brand">云诊所患者端</div><nav class="nav"><a href="/#departments">预约挂号</a><a href="/user/dashboard">个人中心</a><a href="/doctor">医生端</a><a href="/admin/login">管理端</a></nav></header>
<section class="hero"><h1>在线预约、电子病历、处方下载一站完成</h1><p>先选科室，再选医生和时间段，操作更清晰。</p><a class="btn" href="/#departments">立即选择科室</a></section>
