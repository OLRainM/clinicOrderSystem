...
<main class="container"><div class="toolbar"><a class="btn secondary" href="/">返回首页</a><h2>${departmentName}医生与排班</h2><label>预约日期 <input id="date" type="date"></label><button class="btn" onclick="loadDepartmentSchedules()">刷新号源</button></div><div class="easy-tip">操作提示：点击医生卡片即可查看全部具体时间段，例如 08:00-08:30；蓝色表示可预约，黑色表示暂无号源。</div>
