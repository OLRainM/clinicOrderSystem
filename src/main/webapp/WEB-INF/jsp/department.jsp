...
<main class="container"><div class="toolbar"><h2>${departmentName}医生与排班</h2><label>预约日期 <input id="date" type="date"></label><span class="muted">登录患者：演示账号 1001</span><button class="btn" onclick="loadDepartmentSchedules()">刷新号源</button></div>
